...
{
    // Mantém a janela na mesma posição independente do resize
    IMGUI_CHECKVERSION();
    ImGui::CreateContext();
...
void MouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
{
    if (button == GLFW_MOUSE_BUTTON_LEFT && action == GLFW_PRESS)
    {
        ...
        // if (RayAABBIntersection(rayOrigin, rayDir, planeAABB)) {
        //     selectedObject = PLANE;  // assuming you've defined these identifiers
        // }
        // else if (RayAABBIntersection(rayOrigin, rayDir, bunnyAABB)) {
        //     selectedObject = BUNNY;
        // }
        // else if (RayAABBIntersection(rayOrigin, rayDir, sphereAABB)) {
