...
void main()
{
    ...
    // TAREFA 2 
    // Implementar a leitura de uma segunda textura (TextureImage1) 
    // que define as luzes ligadas na superfície do planeta durante a noite (arquivo data/tc-earth_nightmap_citylights.gif), 
    // a qual deve ter suas cores combinadas com a da textura que já está sendo utilizada (TextureImage0). 
    vec3 Kd1 = texture(TextureImage1, vec2(U,V)).rgb;


    //TAREFA 2
    // Utilize o termo de Lambert definido no código para fazer uma transição suave entre luzes ligadas/desligadas.
    ...
    // combinacao de cores
    color.rgb = Kd0 * (lambert0 + 0.01) + Kd1 * (lambert1);
