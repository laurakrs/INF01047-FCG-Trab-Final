...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // nova chamada para a tarefa 2 - segunda parte. o vetor possui 34 indices (para fechar o circulo)
...
GLuint BuildTriangles()
{
    ...
    // Funcao alterada para desenhar uma "rosquinha"


     // A distância de qualquer vértice externo para o vértice central deve ser 0.7 unidades (NDC)
    GLfloat externalRadius = 0.7f;
    GLfloat internalRadius = 0.5f;

    // Número de vértices externos e internos
    GLint numberOfVertices = 32;

    // Numero de lados ou divisoes (angulos)
    GLint numberOfSides = numberOfVertices - 1;

    // Define o valor de pi * 2
    ...
    // define as variaveis de partida (centro do circulo)
    GLfloat x = 0.0f;
    GLfloat y = 0.0f;
    GLfloat z = 0.0f;

    // Vetor para armazenar os indices:
    ...
    for (int i = 0; i < numberOfVertices; i++)
    {
        ...
        if(i%2 == 0){ // se for par, raio interno
            circleVerticesX[i] = x + (internalRadius * cos(angle));
            circleVerticesY[i] = y + (internalRadius * sin(angle));
            circleVerticesZ[i] = z;
        }else{ // se for impar, raio externo
            circleVerticesX[i] = x + (externalRadius * cos(angle));
            circleVerticesY[i] = y + (externalRadius * sin(angle));
            circleVerticesZ[i] = z;
        }
    ...
    // array para os coeficientes de cor para cada vertice
    GLfloat color_coefficients[numberOfVertices * 4];

    for (int i = 0; i < numberOfVertices; i++)
    {
       if (i % 2 == 0) { // se for par, eh um vertice interno
        // Vertices internos = vermelho
    ...
    } else { // se for impar, eh um vertice externo
        // Vertices externos = azul
   ...
   // Vetor de índices para definir a ordem dos vértices
